...
A quick-start project that shows how to enable editing in the [Angular Gantt Chart component](https://www.syncfusion.com/angular-components/angular-gantt-chart) of Syncfusion. This project contains code snippets for performing cell, dialog, taskbar, and dependency editing in the component. Gantt component features are segregated into individual feature-wise modules. To use editing feature, inject the Edit module. To use a selection feature, inject the Selection module.
...
- [Gantt Managing Tasks](https://ej2.syncfusion.com/angular/documentation/gantt/managing-tasks)
...
- [Gantt Chart Live Demos and Examples](https://ej2.syncfusion.com/angular/demos/#/bootstrap5/gantt/default-editing)
